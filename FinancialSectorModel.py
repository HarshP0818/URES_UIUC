...
XLF_data = pd.read_csv(r"C:/Users/harsh/OneDrive/Desktop/XLF.csv", index_col='Date', parse_dates=True)

close_data = XLF_data['Close'].values.reshape(-1, 1)
