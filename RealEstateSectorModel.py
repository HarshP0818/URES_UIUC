...
XLRE_data = pd.read_csv(r"C:/Users/harsh/OneDrive/Desktop/XLRE.csv", index_col='Date', parse_dates=True)

close_data = XLRE_data['Close'].values.reshape(-1, 1)
