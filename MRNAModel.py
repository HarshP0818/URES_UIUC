...
MRNA_data = pd.read_csv(r"C:/Users/harsh/OneDrive/Desktop/MRNA.csv", index_col='Date', parse_dates=True)

close_data = MRNA_data['Close'].values.reshape(-1, 1)
