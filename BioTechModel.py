...
IBB_data = pd.read_csv(r"C:/Users/harsh/OneDrive/Desktop/IBB.csv", index_col='Date', parse_dates=True)

close_data = IBB_data['Close'].values.reshape(-1, 1)
